...
expr-taskcli/0.2.1 darwin-x64 node-v14.7.0
...
_See code: [src/commands/run.js](https://github.com/yjhatfdu/taskcli/blob/v0.2.1/src/commands/run.js)_
...
_See code: [src/commands/stop.js](https://github.com/yjhatfdu/taskcli/blob/v0.2.1/src/commands/stop.js)_
...
_See code: [src/commands/submit.js](https://github.com/yjhatfdu/taskcli/blob/v0.2.1/src/commands/submit.js)_
...
_See code: [src/commands/update.js](https://github.com/yjhatfdu/taskcli/blob/v0.2.1/src/commands/update.js)_
<!-- commandsstop -->
